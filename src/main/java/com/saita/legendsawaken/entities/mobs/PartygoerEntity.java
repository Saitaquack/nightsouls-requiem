...
public class PartygoerEntity extends Monster {
	...
	public PartygoerEntity(EntityType<PartygoerEntity> entityType, Level level) {
	...
	protected void registerGoals() {
	 ...
	 public static boolean canSpawn(EntityType<PartygoerEntity> entityType, LevelAccessor level, MobSpawnType spawnType, BlockPos position, RandomSource random) {
	...
	protected SoundEvent getDeathSound() {
		...
		return SoundInit.PARTYGOER_DEATH.get();
	}
	 
	@Override
	protected SoundEvent getHurtSound(DamageSource p_33034_) {
		 
		return SoundInit.PARTYGOER_HURT.get();
	}
