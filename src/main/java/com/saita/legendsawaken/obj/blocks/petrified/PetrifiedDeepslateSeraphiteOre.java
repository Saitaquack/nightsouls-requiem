...
public class PetrifiedDeepslateSeraphiteOre extends RotatedPillarBlock {
	
	BlockState requiemBlock = BlockInit.DEEPSLATE_SERAPHITE_ORE.get().defaultBlockState();

	public PetrifiedDeepslateSeraphiteOre(Properties p_49795_) {
		super(p_49795_);
