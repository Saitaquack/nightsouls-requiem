...
public class PetrifiedCosmoliteOre extends Block {
	
	BlockState requiemBlock = BlockInit.COSMOLITE_ORE.get().defaultBlockState();

	public PetrifiedCosmoliteOre(Properties p_49795_) {
		super(p_49795_);
