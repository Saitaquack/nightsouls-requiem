...
public class PetrifiedMythrilOre extends Block {
	
	BlockState hardmodeBlock = BlockInit.MYTHRIL_ORE.get().defaultBlockState();

	public PetrifiedMythrilOre(Properties p_49795_) {
		super(p_49795_);
