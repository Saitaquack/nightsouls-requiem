...
public class PetrifiedDeepslateVitalCrystalOre extends RotatedPillarBlock {
	
	BlockState hardmodeBlock = BlockInit.DEEPSLATE_VITAL_CRYSTAL_ORE.get().defaultBlockState();

	public PetrifiedDeepslateVitalCrystalOre(Properties p_49795_) {
		super(p_49795_);
