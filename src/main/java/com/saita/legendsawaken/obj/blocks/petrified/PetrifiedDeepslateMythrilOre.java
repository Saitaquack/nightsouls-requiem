...
public class PetrifiedDeepslateMythrilOre extends RotatedPillarBlock {
	
	BlockState hardmodeBlock = BlockInit.DEEPSLATE_MYTHRIL_ORE.get().defaultBlockState();

	public PetrifiedDeepslateMythrilOre(Properties p_49795_) {
		super(p_49795_);
