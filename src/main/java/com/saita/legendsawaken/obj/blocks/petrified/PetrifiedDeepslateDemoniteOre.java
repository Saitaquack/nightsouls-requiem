...
public class PetrifiedDeepslateDemoniteOre extends RotatedPillarBlock {
	
	BlockState requiemBlock = BlockInit.DEEPSLATE_DEMONITE_ORE.get().defaultBlockState();

	public PetrifiedDeepslateDemoniteOre(Properties p_49795_) {
		super(p_49795_);
