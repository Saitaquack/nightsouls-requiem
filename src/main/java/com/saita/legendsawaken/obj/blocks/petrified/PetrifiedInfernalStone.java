...
public class PetrifiedInfernalStone extends RotatedPillarBlock {
	
	BlockState hardmodeBlock = BlockInit.INFERNAL_STONE.get().defaultBlockState();

	public PetrifiedInfernalStone(Properties p_49795_) {
		super(p_49795_);
