...
public class PetrifiedDeepslateWarpstoneOre extends RotatedPillarBlock {
	
	BlockState requiemBlock = BlockInit.DEEPSLATE_WARPSTONE_ORE.get().defaultBlockState();

	public PetrifiedDeepslateWarpstoneOre(Properties p_49795_) {
		super(p_49795_);
