...
public class PetrifiedAbyssalDemoniteOre extends Block {
	
	BlockState requiemBlock = BlockInit.ABYSSAL_DEMONITE_ORE.get().defaultBlockState();

	public PetrifiedAbyssalDemoniteOre(Properties p_49795_) {
		super(p_49795_);
