...
public class PetrifiedDeepslateTitaniteOre extends RotatedPillarBlock {
	
	BlockState hardmodeBlock = BlockInit.DEEPSLATE_TITANITE_ORE.get().defaultBlockState();

	public PetrifiedDeepslateTitaniteOre(Properties p_49795_) {
		super(p_49795_);
