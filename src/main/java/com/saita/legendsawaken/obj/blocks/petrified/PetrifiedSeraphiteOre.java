...
public class PetrifiedSeraphiteOre extends Block {
	
	BlockState requiemBlock = BlockInit.SERAPHITE_ORE.get().defaultBlockState();

	public PetrifiedSeraphiteOre(Properties p_49795_) {
		super(p_49795_);
