...
public class PetrifiedVitalCrystalOre extends Block {
	
	BlockState hardmodeBlock = BlockInit.VITAL_CRYSTAL_ORE.get().defaultBlockState();

	public PetrifiedVitalCrystalOre(Properties p_49795_) {
		super(p_49795_);
