...
public class PetrifiedWarpstoneOre extends Block {
	
	BlockState requiemBlock = BlockInit.WARPSTONE_ORE.get().defaultBlockState();

	public PetrifiedWarpstoneOre(Properties p_49795_) {
		super(p_49795_);
