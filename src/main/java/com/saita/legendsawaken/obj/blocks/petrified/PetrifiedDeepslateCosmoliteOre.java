...
public class PetrifiedDeepslateCosmoliteOre extends RotatedPillarBlock {
	
	BlockState requiemBlock = BlockInit.DEEPSLATE_COSMOLITE_ORE.get().defaultBlockState();

	public PetrifiedDeepslateCosmoliteOre(Properties p_49795_) {
		super(p_49795_);
