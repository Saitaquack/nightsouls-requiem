...
public class SpeedTitaniteChestplate extends TitaniteArmor {

	public SpeedTitaniteChestplate(ArmorMaterial p_40386_, Type p_266831_, Properties p_40388_) {
	...
	public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
		...
		components.add(Component.translatable("titanite_armor.speed_chestplate"));
	...
	public void onArmorTick(ItemStack stack, Level level, Player player) {
		...
		if(player.getItemBySlot(EquipmentSlot.HEAD).getItem() == ItemInit.TITANITE_HELMET.get() &&
		   player.getItemBySlot(EquipmentSlot.CHEST).getItem() == ItemInit.SPEED_TITANITE_CHESTPLATE.get() &&
