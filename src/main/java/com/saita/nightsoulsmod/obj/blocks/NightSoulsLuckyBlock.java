...
public class NightSoulsLuckyBlock extends Block {
	...
	public void harvestBlock(World worldIn, PlayerEntity player, BlockPos pos, BlockState state, TileEntity te,
		...
		{
			 boolean randomStar = RANDOM.nextBoolean();
			 ...
			 {
				 ItemStack starPlatinum = new ItemStack(ItemInit.STAR_PLATINUM.get(), 1);
				 spawnAsEntity(worldIn, pos, starPlatinum);
			 }
		...
		else if(randomPrice < 639)
		{
		    ...
		    ItemStack disc29 = new ItemStack(ItemInit.MALZENO_MUSIC_DISC.get());
		    ItemStack disc30 = new ItemStack(ItemInit.KAKYOIN_MUSIC_DISC.get());
		    ItemStack disc31 = new ItemStack(ItemInit.GIGACHAD_MUSIC_DISC.get());
