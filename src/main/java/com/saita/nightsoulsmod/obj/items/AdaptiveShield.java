...
public class AdaptiveShield extends Item {
	...
	return Rarity.RARE;
	 ...
	 public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	 {
	   ...
	   tooltip.add(new StringTextComponent("§7Grants you absorption. Effect gets stronger if you are at low HP. Cooldown : 20 seconds. Cooldown is 14 seconds with cranite, necro, nightsouls, dragon, hallowed paladin or paragonic armor."));
