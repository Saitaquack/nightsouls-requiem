...
public class AmpItUp extends Item {
	...
	return Rarity.RARE;
	 ...
	 public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	 {
	   ...
	   tooltip.add(new StringTextComponent("§7Grants you a big speed buff and regeneration. Cooldown : 16 seconds. Cooldown is 12 seconds with cranite, necro, nightsouls, dragon, hallowed paladin or paragonic armor."));
