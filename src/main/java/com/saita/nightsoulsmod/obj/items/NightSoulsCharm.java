...
public class NightSoulsCharm extends Item {
    ...
    tooltip.add(new StringTextComponent("§7While in your inventory, if you are below 3 hearts, you will get temporary invincibility, regeneration and speed. If you fall into the void, you will get teleported back to safety and gain the same buffs. The item gets consumed once it has saved you once."));
