...
public class VampireMask extends ArmorItem {
	...
	tooltip.add(new StringTextComponent("§4WARNING : §7Putting this mask on will reject your humanity. You will become a vampire until you die and lose the mask. You will become extremely powerful, but stay away from any form of light ! The mask can be destroyed using a purification gem."));			
