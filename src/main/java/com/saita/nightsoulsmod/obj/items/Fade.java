...
public class Fade extends Item {
	...
	return Rarity.RARE;
	 ...
	 public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	 {
	   ...
	   tooltip.add(new StringTextComponent("§7Gives you a quick speed buff and makes you invisible and invulnerable. Cooldown : 12 seconds. Cooldown is 8 seconds with saitastone, bloody, nightsouls, dragon, milky way or paragonic armor."));
