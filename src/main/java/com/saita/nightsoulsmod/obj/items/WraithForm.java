...
public class WraithForm extends Item{
	...
	return Rarity.RARE;
	 ...
	 public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	 {
	   ...
	   tooltip.add(new StringTextComponent("§7Become invisible, faster and invulnerable. Cooldown : 12 seconds. Cooldown is 8 seconds with miizealite, necro, nightsouls, dragon, hellfire emperor or paragonic armor. Cooldown is 6 seconds with a vampire mask."));
