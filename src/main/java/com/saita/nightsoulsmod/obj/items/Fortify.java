...
public class Fortify extends Item {
	...
	return Rarity.RARE;
	 ...
	 public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	 {
	   ...
	   tooltip.add(new StringTextComponent("§7Grants you resistance and makes you glow. Cooldown : 16 seconds. Cooldown is 12 seconds with bastirite, alternate, nightsouls, dragon, binary or paragonic armor."));
