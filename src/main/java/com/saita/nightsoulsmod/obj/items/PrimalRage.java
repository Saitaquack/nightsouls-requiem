...
public class PrimalRage extends Item {
	...
	return Rarity.EPIC;
	 ...
	 public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	 {
	   ...
	   tooltip.add(new StringTextComponent("§7Gain immense health instantly, and jump super high. Cooldown : 3 minutes"));
	 ...
	 @Override
	    ...
	    playerIn.getCooldownTracker().setCooldown(ItemInit.NANO_BOOST.get(), 3600);
