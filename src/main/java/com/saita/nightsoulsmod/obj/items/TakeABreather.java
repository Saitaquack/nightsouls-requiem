...
public class TakeABreather extends Item {
	...
	return Rarity.RARE;
	 ...
	 public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	 {
	   ...
	   tooltip.add(new StringTextComponent("§7Grants you quick regeneration as well as resistance. Cooldown : 16 seconds. Cooldown is 12 seconds with saitastone, bloody, nightsouls, dragon, milky way or paragonic armor."));
