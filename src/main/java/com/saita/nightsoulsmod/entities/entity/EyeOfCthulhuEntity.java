    ...
    // Vex Code
	 ...
	 public void move(MoverType typeIn, Vector3d pos) {
	   ...
	   class CopyOwnerTargetGoal extends TargetGoal {
	       ...
	       */
	      public boolean shouldExecute() {
	         return EyeOfCthulhuEntity.this.owner != null && EyeOfCthulhuEntity.this.owner.getAttackTarget() != null && this.isSuitableTarget(EyeOfCthulhuEntity.this.owner.getAttackTarget(), this.field_220803_b);
	      }
	       ...
	       */
	      public void startExecuting() {
	         EyeOfCthulhuEntity.this.setAttackTarget(EyeOfCthulhuEntity.this.owner.getAttackTarget());
	   ...
	   class MoveHelperController extends MovementController {
	      ...
	      public void tick() {	    	  	    	  
	    	  ...
	    	  {
	    		  EyeOfCthulhuEntity.this.addPotionEffect(new EffectInstance(Effects.STRENGTH, 5, 1));
	    	  }
	         ...
	         if (this.action == MovementController.Action.MOVE_TO) {
	            ...
	            if (d0 < EyeOfCthulhuEntity.this.getBoundingBox().getAverageEdgeLength()) {
	               ...
	               EyeOfCthulhuEntity.this.setMotion(EyeOfCthulhuEntity.this.getMotion().scale(0.5D));
	            	...
	            	{
	            		EyeOfCthulhuEntity.this.setMotion(EyeOfCthulhuEntity.this.getMotion().add(vector3d.scale(this.speed * 0.10D / d0))); //0.05 de base, 2x plus rapide
	            	}
