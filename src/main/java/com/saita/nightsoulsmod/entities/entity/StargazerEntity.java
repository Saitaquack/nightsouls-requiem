...
public class StargazerEntity extends MonsterEntity {

	public StargazerEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
		super(type, worldIn);
	...
	protected SoundEvent getAmbientSound() {
		...
		return SoundInit.STARGAZER_HIT.get();
	}
	     ...
	     if (!super.attackEntityAsMob(entityIn)) {
	         return false;
	            ...
	            if (entityIn instanceof LivingEntity) {
	            	...
	            	int randomLevitation = random.nextInt(4);
