...
public class WindigoEntity extends MonsterEntity {

	public WindigoEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
		super(type, worldIn);
	...
	protected SoundEvent getAmbientSound() {
		...
		return SoundInit.WINDIGO_AMBIENT.get();
	}
	
	@Override
	protected SoundEvent getDeathSound() {
		
		return SoundInit.WINDIGO_DEATH.get();
	}
	
	@Override
	protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
		
		return SoundInit.WINDIGO_HIT.get();
	}
	     ...
	     if (!super.attackEntityAsMob(entityIn)) {
	         return false;
	            ...
	            if (entityIn instanceof LivingEntity) {
	                ((LivingEntity) entityIn).addPotionEffect(new EffectInstance(Effects.HUNGER, 200, 3));
	            }
	            return true;
	        }
