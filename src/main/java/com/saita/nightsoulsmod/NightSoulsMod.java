...
public class NightSoulsMod
{
    ...
    {
    	LOGGER.info("Hello from NightSouls Mod Requiem 9.1!");
    	...
    	event.enqueueWork(() -> {
    		...
    		ComposterBlock.CHANCES.put(ItemInit.CRYSTAL_SEEDS.get(), 0.6F);
    		ComposterBlock.CHANCES.put(ItemInit.SAITASTONE_SEEDS.get(), 0.6F);
    		ComposterBlock.CHANCES.put(ItemInit.MIIZEALITE_SEEDS.get(), 0.6F);
    		ComposterBlock.CHANCES.put(ItemInit.CRANITE_SEEDS.get(), 0.6F);
    		ComposterBlock.CHANCES.put(ItemInit.BASTIRITE_SEEDS.get(), 0.6F);
    		ComposterBlock.CHANCES.put(ItemInit.PURE_BLUE_CRYSTAL_SEEDS.get(), 1.0F);
    		ComposterBlock.CHANCES.put(ItemInit.GELATIN_CRYSTAL.get(), 1.0F);
    		ComposterBlock.CHANCES.put(ItemInit.PURE_BLUE_GELATIN_CRYSTAL.get(), 1.0F);
    	});
    }
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
    	  ...
    	  RenderingRegistry.registerEntityRenderingHandler(NightSoulsEntityTypes.PARTYGOER.get(), PartygoerRenderer::new);
    	  RenderingRegistry.registerEntityRenderingHandler(NightSoulsEntityTypes.WINDIGO.get(), WindigoRenderer::new);
    	  ...
    	  RenderingRegistry.registerEntityRenderingHandler(NightSoulsEntityTypes.TITAN.get(), TitanRenderer::new);
    	  ...
    	  RenderingRegistry.registerEntityRenderingHandler(NightSoulsEntityTypes.SPAZMATISM.get(), SpazmatismRenderer::new);
    	  RenderingRegistry.registerEntityRenderingHandler(NightSoulsEntityTypes.RETINAZER.get(), RetinazerRenderer::new);
    }
