...
public class OreGen {
	...
	public static void generateOres(final BiomeLoadingEvent event) {
			...
			if (!(event.getCategory().equals(Biome.Category.NETHER) || event.getCategory().equals(Biome.Category.THEEND))) {
				...
				generateOre(event.getGeneration(), OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD,
						BlockInit.THERENITE_ORE.get().getDefaultState(), 8, 1, 25, 1);
			...
			if (event.getCategory().equals(Biome.Category.JUNGLE)) {
				...
				generateOre(event.getGeneration(), OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD,
						BlockInit.PETRIFIED_CHLOROPHYTE_ORE.get().getDefaultState(), 16, 1, 48, 2);		
			...
			if (event.getCategory().equals(Biome.Category.NETHER)) {
				...
				generateOre(event.getGeneration(), OreFeatureConfig.FillerBlockType.BASE_STONE_NETHER,
						Blocks.ANCIENT_DEBRIS.getDefaultState(), 6, 1, 64, 3);
