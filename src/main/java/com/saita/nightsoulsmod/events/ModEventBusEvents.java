...
public class ModEventBusEvents {
    ...
    public static void addEntityAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(NightSoulsEntityTypes.PARTYGOER.get(), PartygoerEntity.setCustomAttributes().create());
        event.put(NightSoulsEntityTypes.WINDIGO.get(), WindigoEntity.setCustomAttributes().create());
        ...
        event.put(NightSoulsEntityTypes.SPAZMATISM.get(), SpazmatismEntity.setCustomAttributes().create());
        event.put(NightSoulsEntityTypes.RETINAZER.get(), RetinazerEntity.setCustomAttributes().create());
