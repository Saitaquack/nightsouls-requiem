...
public class NightSoulsEntityTypes {
	 ...
	 public static final RegistryObject<EntityType<WerewolfEntity>> WEREWOLF =
	          ENTITY_TYPES.register("werewolf", () -> EntityType.Builder
	            	.create(WerewolfEntity::new, EntityClassification.MONSTER).size(0.8F, 2.05F)
	 ...
	 public static final RegistryObject<EntityType<WindigoEntity>> WINDIGO =
	          ENTITY_TYPES.register("windigo", () -> EntityType.Builder
	            	.create(WindigoEntity::new, EntityClassification.MONSTER).size(1.2F, 3.0F)
	                .build(new ResourceLocation(NightSoulsMod.MOD_ID, "windigo").toString()));
	 ...
	 public static final RegistryObject<EntityType<EyeOfCthulhuEntity>> EYE_OF_CTHULHU =
	          ENTITY_TYPES.register("eye_of_cthulhu", () -> EntityType.Builder
	            	.create(EyeOfCthulhuEntity::new, EntityClassification.MONSTER).size(5.0F, 5.0F)
	 ...
	 public static final RegistryObject<EntityType<SpazmatismEntity>> SPAZMATISM =
	          ENTITY_TYPES.register("spazmatism", () -> EntityType.Builder
	            	.create(SpazmatismEntity::new, EntityClassification.MONSTER).size(5.0F, 5.0F)
	            	.immuneToFire()
	                .build(new ResourceLocation(NightSoulsMod.MOD_ID, "spazmatism").toString()));
	 
	 public static final RegistryObject<EntityType<RetinazerEntity>> RETINAZER =
	          ENTITY_TYPES.register("retinazer", () -> EntityType.Builder
	            	.create(RetinazerEntity::new, EntityClassification.MONSTER).size(5.0F, 5.0F)
	            	.immuneToFire()
	                .build(new ResourceLocation(NightSoulsMod.MOD_ID, "retinazer").toString()));
	 ...
	 public static final RegistryObject<EntityType<SpazmatismProjEntity>> SPAZMATISM_PROJ = ENTITY_TYPES.register("spazmatism_proj", 
				() -> EntityType.Builder.<SpazmatismProjEntity>create(SpazmatismProjEntity::new, EntityClassification.MISC).size(0.75F, 0.75F).build("spazmatism_proj"));
	 
	 public static final RegistryObject<EntityType<RetinazerProjEntity>> RETINAZER_PROJ = ENTITY_TYPES.register("retinazer_proj", 
				() -> EntityType.Builder.<RetinazerProjEntity>create(RetinazerProjEntity::new, EntityClassification.MISC).size(0.75F, 0.75F).build("retinazer_proj"));
	 
	 public static final RegistryObject<EntityType<BioticProjEntity>> BIOTIC_PROJ = ENTITY_TYPES.register("biotic_proj", 
				() -> EntityType.Builder.<BioticProjEntity>create(BioticProjEntity::new, EntityClassification.MISC).size(0.3F, 0.3F).build("biotic_proj"));
